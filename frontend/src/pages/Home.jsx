    ...
    <div className="home">
      <section className="home__hero">
        ...
        <div className="home__actions">
          ...
          <SignedIn>
            <Link to="/new-listing" className="home__btn home__btn--secondary">
              Anunciar carta
            </Link>
          </SignedIn>
        </div>
      ...
      <section className="home__features">
        <div className="home__feature">
          ...
          <p className="home__feature-text">Cartas com certificação PSA, CGC e BGS verificadas pela plataforma.</p>
        </div>
        <div className="home__feature">
          <span className="home__feature-icon">💳</span>
          <h3 className="home__feature-title">Pagamento protegido</h3>
          <p className="home__feature-text">Seu dinheiro fica retido até você confirmar o recebimento da carta.</p>
        </div>
        <div className="home__feature">
          <span className="home__feature-icon">🃏</span>
          <h3 className="home__feature-title">Catálogo completo</h3>
          <p className="home__feature-text">Mais de 15 mil cartas cadastradas com preço de referência atualizado.</p>
        </div>
      </section>
    </div>
  )
